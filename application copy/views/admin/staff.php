                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h8 mb-0 font-weight-bold text-gray-800 text-capitalize"><?= $kesiswaan['nama']; ?></div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h8 mb-0 font-weight-bold text-gray-800 text-capitalize"><?= $kurikulum['nama']; ?> </div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
                          <div class="h8 mb-0 mr-3 font-weight-bold text-gray-800 text-capitalize"><?= $tatausaha['nama']; ?></div>
                        </div>
                      </div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h8 mb-0 font-weight-bold text-gray-800 text-capitalize"><?= $sarana['nama']; ?></div>
                    </div>
                    <div class="col-auto">
