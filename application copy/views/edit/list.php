             ...
             <div class="container-fluid">
                 ...
                 <div class="row">
                 	<div class="col-lg-8">
                 		<form action="<?= base_url('edit/list/') . $materi['id'] . '/' . $materi['user_id']; ?>" method="post">
						  ...
						  <div class="form-group row">
						    ...
						    <label for="waktu" class="col-sm-1 col-form-label"> Waktu</label>
						    <div class="col-sm-3">
						      <input type="number" class="form-control" id="waktu" name="waktu" value="<?= $materi['waktu']; ?>">
