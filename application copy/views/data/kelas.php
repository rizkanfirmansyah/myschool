    ...
    <div class="d-sm-flex align-items-center mb-4">
                  ...
                  <tbody>
                      ...
                      <?php foreach($kelas as $k):?>
                        <tr>
                            ...
                            <td><?= $k['nama'] ?></td>   
                            <td>
                                <a href="#" data-toggle="modal" data-target="#tambahKelas" class="editKelas" data-namakelas="<?= $k['nama_kelas']?>" data-ruangan="<?= $k['ruangan_id'] ?>" data-namaruangan="<?= $k['nama_ruangan']?>" data-guru="<?= $k['guru_id'] ?>" data-namaguru="<?= $k['nama'] ?>" data-jurusan="<?= $k['jurusan_id'] ?>" data-namajurusan="<?= $k['nama_jurusan'] ?>"><i class="fas fa-edit text-warning"></i></a> 
          ...
          <?php $this->load->view('data/kelas/modal_kelas2'); ?>
        </div>
        </div>
        </div>