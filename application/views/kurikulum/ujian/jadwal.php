    ...
    <div class="d-sm-flex align-items-center mb-4">
              ...
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Data Ujian</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $jmlujian ;?></div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered table-sm" id="datatable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                      <?php $i=1;?>
                      <?php foreach($jadwalujian as $k):?>
                        <tr>
                            <td><?= $i;?></td>
                            <td><?= hari_function(date('D', strtotime($k['mulai'])));?></td>
                            <td><?= $k['nama_ujian'] ?></td>   
                            ...
                            <td><?= $k['mulai'] ?></td>   
                            <td><?= $k['selesai'] ?></td>   
                            <td><?= status_jadwal_ujian($k['status'], $k['idjadwal']) ?></td>   
                            <td>
                                <a href="<?= base_url('hapus/jadwalujian/') ?>" id="hapusDataJadwal" data-href="<?= current_url() ?>" data-hapus="<?= $k['idjadwal'] ?>" class="hapusDataJadwal"><i class="fas fa-trash text-danger"></i></a> 
                                <a href="<?= base_url('edit/jadwalujian/'.$k['idjadwal']) ?>" class="text-warning"><i class="fas fa-edit"></i> </a>
                            </td>   
                        </tr>
                        <?php $i++;?>
                      <?php endforeach;?>
          ...
          <?php $this->load->view('kurikulum/ujian/modal_jadwal'); ?>
        </div>
        </div>
        </div>